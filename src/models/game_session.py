...
class GameSession(Base, TimestampMixin):
    ...
    # Time state
    game_date: Mapped[str] = mapped_column(String(10), nullable=False, default="2024-05-01")
    ...
    player_location_id: Mapped[str] = mapped_column(String(128), default="classroom_1d")
